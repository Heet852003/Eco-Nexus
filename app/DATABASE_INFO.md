...
- `app/server/models/User.js` - `let users = []`
- `app/server/models/BuyerRequest.js` - `let requests = []`
- `app/server/models/SellerQuote.js` - `let quotes = []`
- `app/server/models/Transaction.js` - `let transactions = []`
- `app/server/models/ChatMessage.js` - `let messages = []`

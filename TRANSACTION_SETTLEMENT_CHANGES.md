...
**File:** `client/src/app/transaction/[id]/page.tsx`
...
**File:** `server/controllers/buyerController.js`
...
**File:** `server/controllers/blockchainController.js`
...
**File:** `server/routes/transaction.js` (NEW)
- Added route to get transaction by ID
- File: `server/controllers/transactionController.js` (NEW)
...
### 2. Run Schema File
Execute `server/database/snowflake-schema.sql` to create all tables including:
- `USERS`
- `BUYER_REQUESTS`
- `SELLER_QUOTES`
- `TRANSACTIONS`
